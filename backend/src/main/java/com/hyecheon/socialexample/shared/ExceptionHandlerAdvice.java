...
public class ExceptionHandlerAdvice {
    ...
    ApiError handleValidationException(MethodArgumentNotValidException e, HttpServletRequest request) {
        final ApiError apiError = new ApiError(400, "Validation error", request.getServletPath());
